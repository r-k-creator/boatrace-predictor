...
(scripts/simulate_s_rank_bets.pyのS/SS結果=回収率77.3%との比較用)。
...
使い方:
    python scripts/simulate_boat1_baseline.py
"""
import csv
...
def main():
    ...
    print()
    print(f"[比較] S/SSランク選定あり(scripts/simulate_s_rank_bets.py): 回収率77.3%")
